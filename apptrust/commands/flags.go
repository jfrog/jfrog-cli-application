...
var flagsMap = map[string]components.Flag{
	...
	SourceTypeBuildsFlag:              components.NewStringFlag(SourceTypeBuildsFlag, "List of semicolon-separated (;) builds in the form of 'name=buildName1, id=runID1[, include-deps=true][, repo-key=repo1][, started=2023-01-01T00:00:00Z]; name=buildName2, id=runID2[, include-deps=true][, repo-key=repo2][, started=2023-01-01T00:00:00Z]' to be included in the new version.", func(f *components.StringFlag) { f.Mandatory = false }),
