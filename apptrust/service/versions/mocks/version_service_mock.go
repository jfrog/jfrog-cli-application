...
func (m *MockVersionService) CreateAppVersion(ctx service.Context, request *model.CreateAppVersionRequest, dryRun bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAppVersion", ctx, request, dryRun)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateAppVersion indicates an expected call of CreateAppVersion.
func (mr *MockVersionServiceMockRecorder) CreateAppVersion(ctx, request, dryRun any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAppVersion", reflect.TypeOf((*MockVersionService)(nil).CreateAppVersion), ctx, request, dryRun)
}
